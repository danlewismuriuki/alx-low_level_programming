...
/**
 * check97 - Function that checks for the correct number of arguments
 *
...
/**
 * check98 - Function that checks file_from exists and can be read
 * @check: Function that checks if true of false
 * @file: file_from name
